 ...
 */
export class DaoPetitChien implements IDaoPetitChien {
    ...
    private static currentId: number = 5;
    ...
    addDog(dog: PetitChien): Promise<boolean> {
        return new Promise((resolve, reject) => {
    ...
    removeDog(dog: PetitChien): Promise<boolean> {
        return new Promise((resolve, reject) => {
        /**
    ...
    updateDog(dog: PetitChien): Promise<boolean> {
        return new Promise((resolve, reject) => {
        /**
